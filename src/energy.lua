...
M.list = {
  ...
  },
  {
    ...
    name     = "Higgs Manifold",
    short    = "HIG",
    desc     = "Mass-energy conversion via stabilized Higgs-condensate channels. Direct mass-to-photon flux.",
    tech     = "Higgs condensate / mass→γ",
    spec     = "126 GeV resonance lattice",
    cf       = "CF ~99.8%",
    produce  = 12000000,
    cost     = 4800000000,
    growth   = 1.20,
    color    = { 1.00, 0.50, 0.95 },
    dynamic  = "soft_pulse",
    note     = "Slight resonance",
  },
  {
    key      = "eternal_sun",
    tier     = 10,
    name     = "Eternal Sun",
    short    = "ETSN",
    desc     = "Pocket-dimension star anchored by a captive event horizon. Power comparable to a Class M dwarf.",
    tech     = "Captive star / Bekenstein bound",
    spec     = "Pocket Schwarzschild shell",
    cf       = "CF ~99.95%",
    produce  = 95000000,
    cost     = 70000000000,
    growth   = 1.22,
  ...
  },
  {
    ...
    name     = "Multiverse Tap",
    short    = "MVT",
    desc     = "Thermodynamic siphon across parallel branches. Imports photonic excess from cooler universes.",
    tech     = "Cross-brane thermodynamic siphon",
    spec     = "Everett-routing manifold",
    cf       = "CF 100%",
    produce  = 720000000,
    cost     = 950000000000,
    growth   = 1.25,
