...
M.list = {
  ...
  },
  {
    ...
    name      = "Cosmos Lattice",
    short     = "COSM",
    desc      = "11-dimensional brane resonator. Hash space is collapsed onto the player's local slice of inflation foam.",
    algo      = "Brane-resonant SHA-Z",
    hashrate  = "uncountable",
    efficiency = "negative-entropy",
    spec      = "M-theory shell / 11D",
    produce   = 480000,
    energy    = 180000,
    cost      = 950000000,
    growth    = 1.115,
  ...
  },
  {
    ...
    name      = "Eldritch Prime",
    short     = "ELDR",
    desc      = "Hash-eldritch reality forge. Numbers refuse to canonicalize; nonces volunteer themselves.",
    algo      = "Acausal Nonce Volunteer",
    hashrate  = "non-Euclidean",
    efficiency = "transcendent",
    spec      = "Tindalos hound coil",
    produce   = 3500000,
    energy    = 1100000,
    cost      = 14000000000,
    growth    = 1.12,
    color     = { 0.90, 0.45, 1.00 },
  },
  {
    key       = "omega_engine",
    tier      = 10,
    name      = "Omega Engine",
    short     = "OMEG",
    desc      = "Endgame. The block solves itself the moment the engine is observed. Heat death is the limit.",
    algo      = "Anthropic-Self-Solving",
    hashrate  = "Ω",
    efficiency = "adiabatic",
    spec      = "Tipler-cylinder core",
    produce   = 28000000,
    energy    = 8500000,
    cost      = 220000000000,
    growth    = 1.13,
